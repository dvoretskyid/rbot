...
async def support(message: Message, state: FSMContext):
    ...
    await message.answer(SUPPORT_TEXT["start"], reply_markup=support_menu)
    await state.update_data(full_name=message.from_user.full_name, username=message.from_user.username)
